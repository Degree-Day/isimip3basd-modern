    ...
    with dask.config.set({"array.rechunk.method": "tasks"}), LocalCluster(
        ...
        for variable in VARIABLES:
            ...
            historical = open_variable(
                Path(
                    f"/nas/dat1/cmip6_fwi/inputs/standardized_1deg/ACCESS-CM2/historical/hist/{variable}.zarr"
                ),
                variable,
            ).sel(
            ...
            simulation = open_variable(
                Path(
                    f"/nas/dat1/cmip6_fwi/inputs/standardized_1deg/ACCESS-CM2/ssp245/projection/{variable}.zarr"
                ),
                variable,
