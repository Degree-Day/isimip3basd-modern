...
RAW_ROOT=${RAW_ROOT:-/nas/dat1/cmip6_fwi/inputs/raw}
CANONICAL_ROOT=${CANONICAL_ROOT:-/nas/dat1/cmip6_fwi/inputs/standardized_1deg}
REFERENCE_ROOT=${REFERENCE_ROOT:-/nas/dat1/cmip6_fwi/reference/prepared_local_noon}
REFERENCE_SOURCE=${REFERENCE_SOURCE:-/nas/dat1/cmip6_fwi/reference/era5land/noon_daily.zarr}
...
REFERENCE_COASTAL_PLAN=${REFERENCE_COASTAL_PLAN:-/nas/dat1/cmip6_fwi/processing/downscaled_0p1deg/reference_qc/era5land_coastal_fill_plan.zarr}
ADJUSTED_ROOT=${ADJUSTED_ROOT:-/nas/dat1/cmip6_fwi/processing/bias_adjusted_1deg}
DOWNSCALED_ROOT=${DOWNSCALED_ROOT:-/nas/dat1/cmip6_fwi/processing/downscaled_0p1deg}
FWI_ROOT=${FWI_ROOT:-/nas/dat1/cmip6_fwi/processing/fwi}
...
FIT_CACHE_ROOT=${FIT_CACHE_ROOT:-/nas/dat1/cmip6_fwi/processing/bias_fit_cache}
